...
<!-- list of found items for book section -->
...
<td> <?php echo $row['location'];
 ?></td>
<td> <?php echo '<img src="data:image;base64,'.base64_encode($row['tb2image']).'"alt="image" style="width:100px;height"100px;" >';?></td>
</tr>
<?php	
