...
<body>
<center>
<!-- list of found items for personal items section -->
...
<td> <?php echo $row['location'];
 ?></td>
<td> <?php echo '<img src="data:image;base64,'.base64_encode($row['tb7image']).'"alt="image" style="width:100px;height"100px;" >';?></td>
</tr>
<?php	
